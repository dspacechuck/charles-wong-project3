...
const AddAStoryForm = (props) => {
    ...
    const changeFormState = (enableForm = false) => {
        console.log(enableForm);
        console.log(submitBtn);
        if (enableForm) {
            // submitBtn.disabled = true;
            // slideOutForm.disabled = false;
            submitBtn.innerText = "Post It!";
        } else if (!enableForm) {
            // slideOutForm.disabled = true;
            // submitBtn.disabled = true;
    ...
    const handleSubmit = (event) => {
        ...
        // document.querySelector('button[type=submit]').innerText = "Thank You!";
        ...
        //     setStoryTitle("");
        //     setStoryText("");
        //     document.querySelector('button[type=submit]').innerText = "Post It!";
        // }, 2500);
